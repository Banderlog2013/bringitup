...
class MainSlider extends _slider__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  showSlides(n) {
    ...
    } catch (e) {} // Преобразование html коллекции в массив перебор и скрывание слайдов


    Array.from(this.slides).forEach(slide => {
      slide.style.display = 'none';
    }); // this.slides.forEach(slide => { // forEach на псевдомассиве не работает. Необходимо преодразовать псевдомассив в массив
    //     slide.style.display = "none";
    // });
...
class Slider {
  constructor({
    ...
    // передаем объект в качестве аргумента
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay').init(); //player.init();
